...
const ITEMS: Item[] = [
    ...
    content: (
      <>
        <p>
          ...
          <br /><br />
          • 3일 이내의 요양으로 치유될 수 있으면 요양급여를 <div className="jump">지급하지 아니함</div> 
          •  예시: 하루 병원비 10만 원, 20일 치료 시 총 200만 원 <div className="jump">지급 가능</div>
        </p>
        <p>
          <strong>종류</strong>
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <br /><br />• 요양으로 취업하지 못한 기간이 3일 이내인 경우 <div className="jump">미지급</div>
        • 하루 평균임금 70% 지급(2025년 최저 48,232원)
        <br />• 예시: 평균임금 10만 원, 20일 휴업 → 1일 7만 원 × 2<div className="jump">0일 = 140만 원 지급</div>
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        ...
        <br /><br />• 예시: 중증 4급으로 일시금 800만 원 또는 연금 월 50<div className="jump">만 원 선택 가능</div>
      </p>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          ...
          <br /><br />
          ① 직업훈련 비용·직업훈련수당(학비·교재비·실습비 등 <div className="jump2">+ 생계성 수당)</div>
          ② 직장복귀지원금·직장적응훈련비·재활운동비(복귀 격<div className="jump2">려/적응·재활운동 비용)</div>
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      ...
      ② 부상이나 질병에 따른 중증요양상태의 정도가 대통<div className="jump2">령령으로 정한 중증요양상태 등급 기준에 해당할 것</div>
    ...
    content: (
      <>
        ...
        <details>
          ...
          <p>
            ① 기본 지급 원칙<br/>
            • 업무상 사망 시, 평균임금의 120일분 금액을 장례 집행 <div className="jump">유족에게 지급</div>
            • 유족이 없거나 유족이 아닌 사람이 부득이하게 장례를 <div className="jump">치를 경우 실제비용만 지급</div><br/>

            ② 최고·최저 금액 제한<br />
            • 고용노동부장관 고시 기준의 '최고금액'을 초과하거나 <div className="jump">'최저금액'에 미달하면, 각각 최고금액 또는 최저금액만 지급</div><br /> 
            
            ③ 사망 추정 시 선지급<br /> 
            • 근로자가 업무상 사유로 사망하였다고 대통령령에 따<div className="jump">라 '추정'되는 경우, 장례를 치르기 전이라도 유족의 청구로 최저금액을 미리 지급 가능함</div>
            • 이때 유족 순위는 유족급여 기준(제65조)을 따름<br /><br />

            ④ 금액 조정<br />
            • 사망 추정으로 선지급한 장례비가 있으면, 나중에 실제 <div className="jump">장례비를 산정할 때 이미 지급된 금액을 뺀 나머지만 추가 지급함</div>
          </p>
        </details>
      </>
    ),
    ...
    content: (
      <>
        <p>
          ...
          <br /><br />
          • 요양급여·간병급여·장례비·직업재활급여·진폐보상연금<div className="jump">·진폐유족연금 등으로 구성됨<br /></div>
          • 신청·지급은 「산업재해보상보험법」의 진폐 특례 규<div className="jump">정을 따름</div>
        </p>
      </>
    ),
  },
