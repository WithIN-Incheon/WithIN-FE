  ...
  return (
    <div className="dict-page">
      ...
      <main className="dict-content">
        ...
        <p className="paragraph">
          • 근로자가 근로계약에 따른 업무나 그에 따르는 행위<div className="jump">를 하던 중 발생한 사고</div>
          • 사업주가 제공한 시설물 등을 이용하다 그 시설물의 <div className="jump">결함이나 관리 소홀로 발생한 사고</div>
          • 사업주가 주관하거나 지시한 행사 또는 행사 준비 중<div className="jump">에 발생한 사고</div>
          • 휴게시간 중 사업주의 관리하에 있다고 볼 수 있는 행<div className="jump">위 중 발생한 사고</div>
          • 업무와 관련하여 발생한 기타 사고
        </p>
        
        <h3 className="sub-title hl">1-2. 업무상 질병</h3>
        <p className="paragraph">
          • 업무 수행 중 물리적, 화학적, 생물학적 요인에 노출<div className="jump">되어 발생한 질병</div>
          • 업무상 부상에 의해 발생한 질병<br/>
          • 직장 내 괴롭힘이나 고객의 폭언 등 업무 스트레스로 <div className="jump">인한 정신적 질병</div>
          • 업무와 관련하여 발생한 기타 질병
        </p>

        <h3 className="sub-title hl">1-3. 출퇴근 재해</h3>
        <p className="paragraph"> 
          • 사업주가 제공하는 교통수단이나 이에 준하는 통근 <div className="jump">수단을 이용 중 발생한 사고</div>
          • 통상적인 경로와 방법으로 출퇴근하는 도중 발생한 <div className="jump">사고(경로 일탈·중단 시 인정 제한 가능)</div>
        </p>

        <h2 className="sub-title hl">제외 사유</h2>
        <p className="paragraph">
            근로자의 고의, 자해행위, 범죄행위 등으로 인한 부상, 질병, 장해 또는 사망은
            업무상 재해로 인정하지 않음 <br/><br/> 단, 인식능력이 낮아진 상태에서 발생한 경우는 예외
        </p>
