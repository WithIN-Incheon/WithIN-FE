    ...
    <div className="dict-page">
      ...
      <main className="dict-content">
        ...
        <p className="paragraph">
          ...
          크게 업무 상 사고 / 질병 / 출퇴근 재해로 구분됩니다.
        </p>

        {/* 1-1 ~ 1-3 : 하이라이트를 텍스트 폭에 딱 맞춤 */}
        <h3 className="sub-title hl">1-1. 업무상 사고</h3>
        <ul className="dash-list">
          <li>근로자가 근로계약에 따른 업무나 그에 따르는 행위를 하던 중 발생한 사고</li>
          <li>사업주가 제공한 시설물 등을 이용하다 그 시설물의 결함이나 관리 소홀로 발생한 사고</li>
          <li>사업주가 주관하거나 지시한 행사 또는 행사 준비 중에 발생한 사고</li>
          <li>휴게시간 중 사업주의 관리하에 있다고 볼 수 있는 행위 중 발생한 사고</li>
          <li>업무와 관련하여 발생한 기타 사고</li>
        </ul>

        <h3 className="sub-title hl">1-2. 업무상 질병</h3>
        <ul className="dash-list">
          <li>업무 수행 중 물리적, 화학적, 생물학적 요인에 노출되어 발생한 질병</li>
          <li>업무상 부상에 의해 발생한 질병</li>
          <li>직장 내 괴롭힘이나 고객의 폭언 등 업무 스트레스로 인한 정신적 질병</li>
          <li>업무와 관련하여 발생한 기타 질병</li>
        </ul>

        <h3 className="sub-title hl">1-3. 출퇴근 재해</h3>
        <ul className="dash-list">
          <li>사업주가 제공하는 교통수단이나 이에 준하는 통근 수단을 이용 중 발생한 사고</li>
          <li>통상적인 경로와 방법으로 출퇴근하는 도중 발생한 사고(경로 일탈·중단 시 인정 제한 가능)</li>
        </ul>

        <h2 className="sub-title hl">제외 사유</h2>
        <p className="paragraph">
          근로자의 고의, 자해행위, 범죄행위 등으로 인한 부상, 질병, 장해 또는 사망은
          업무상 재해로 인정하지 않습니다. 단, 인식능력이 낮아진 상태에서 발생한 경우는 예외입니다.
        </p>

        {/* 2 ~ 9 */}
        <h2 className="section-title hl">2. 근로자</h2>
        <p className="paragraph">
          사업주에게 근로를 제공하는 사람으로서, 정규직, 계약직, 일용직 근로자 등 모든 고용 형태를 포함합니다.
        </p>

        <h2 className="section-title hl">3. 사업주</h2>
        <p className="paragraph">
          근로자를 고용하고 지휘·감독하며 임금을 지급하는 사람이나 법인을 말합니다.
        </p>

        <h2 className="section-title hl">4. 산재보험가입자</h2>
        <p className="paragraph">
          산업재해보상보험에 가입하여 보험료를 납부하는 사업주 또는 개인을 뜻합니다.
        </p>

        <h2 className="section-title hl">5. 진단서</h2>
        <p className="paragraph">
          의사가 근로자의 부상이나 질병 상태를 진단하고 기록한 공식 문서입니다.
        </p>
        ...
        <p className="paragraph">
          산재보험 급여를 받을 권리가 있는 사람, 피해 근로자 또는 유족을 뜻합니다.
        </p>
